    ...
    Function existingXMLEntry(ByVal strType As String, Optional ByVal strLbl As String = Nothing, Optional ByVal strEdomv As String = Nothing)
        ...
        Select Case strType
            ...
            Case "codesets"
                ...
                strDefault = "Provide Codeset Definition Reference (Citation/URL)"
...
#End Region
    ...
    Private Sub cboCodesetName_AutoComplete(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboCodesetName.SelectedIndexChanged
    ...
    'DI: 4/27/16 Added to handle text change to support free codeset name/source, in addition to the 'index changed' above.
    Private Sub cboCodesetName_TextChange(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboCodesetName.TextChanged
        Dim curCodeset As codesetd
        curCodeset = curEA.attributesDict(Me.lstFields.SelectedItems(0).Text).c_attribdomv.attributeDomainValues(0)
        curCodeset.codesetn = cboCodesetName.Text
        curCodeset.codesets = txtCodesetSource.Text
    ...
    'DI: 4/27/16 This basically repeats the code above but it appears that the code executes so quickly for the Codeset Name that it isn't making
    'it to the Codeset Source. Adding this chunk ensures both of the fields are saved out to the output properly.
    Private Sub txtCodesetSource_TextChange(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtCodesetSource.TextChanged
        Dim curCodeset As codesetd
        curCodeset = curEA.attributesDict(Me.lstFields.SelectedItems(0).Text).c_attribdomv.attributeDomainValues(0)
        curCodeset.codesetn = cboCodesetName.Text
        curCodeset.codesets = txtCodesetSource.Text
